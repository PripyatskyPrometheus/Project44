...
private:
    ...
    void walk_for_task(const Vertex& vert, unordered_map<Vertex, bool>& visited, Distance& sum_length, size_t& num_neighbors) {
        visited[vert] = true;
...
public:
    ...
    Vertex max_average_vert() {
        ...
        for (auto& i : _data) {
            ...
            walk_for_task(i.first, visited, sum_length, num_neighbors);
